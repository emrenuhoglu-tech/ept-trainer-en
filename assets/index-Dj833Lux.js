const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Quiz-CxhkIHKa.js","assets/vendor-nf7bT_Uh.js","assets/quizEngine-DgwisH9V.js","assets/Drill-Cy9yO4H7.js","assets/kavramlar-BaUvBKlS.js","assets/Simulator-BL31Foar.js","assets/Progress-CU_Ivfty.js","assets/QuickReference-oOqyNi3p.js","assets/Sentences-ConvJITc.js","assets/RangeAtlas-ZFGlO0Wg.js","assets/EquityIntuition-CbX1GhIJ.js","assets/BetTypes-C0TEq_U7.js","assets/QuestionBank-BfLjMcSW.js","assets/IcmCard-9gwfPs-s.js"])))=>i.map(i=>d[i]);
var lt=Object.defineProperty;var ht=(t,a,n)=>a in t?lt(t,a,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[a]=n;var H=(t,a,n)=>ht(t,typeof a!="symbol"?a+"":a,n);import{r as d,a as ct,R as ze}from"./vendor-nf7bT_Uh.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();var He={exports:{}},ce={};/**
 * @license React
...
`;function S(t){return t.replace(/\*\*(.+?)\*\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\*(.+?)\*/g,"$1").trim()}function Jt(t){const a=s=>s.trim().replace(/^\|/,"").replace(/\|$/,"").split("|").map(i=>S(i)),n=a(t[0]),o=t.slice(2).map(a);return{headers:n,rows:o}}function D(t){const a=Wt.split(`
...
`)}function hn(){const t=D("Chapter 0"),a=[];let n=null;for(const o of t.split(`
`)){const s=o.match(/^\s*(\d+)\.\s+\*\*(.+?)\*\*\s*$/);s?(n&&a.push(n),n={n:Number(s[1]),rule:S(s[2]),context:""}):n&&o.trim()&&!o.trim().startsWith("#")&&!o.trim().startsWith("*")&&(n.context=(n.context+" "+S(o.trim())).trim())}return n&&a.push(n),a.filter(o=>o.n>=1&&o.n<=15)}function Xe(t){const a=t.split(`
...
`)}),n}function B(t,a){const n=Xe(t).find(o=>o.title.startsWith(a));return n?n.body:""}function Q(t){const a=t.split(`
`),n=[];for(const o of a)if(o.trim().startsWith("|"))n.push(o);else if(n.length)break;return n.length>=2?Jt(n):null}function he(t,a){const n=a?/^\s*\d+\.\s+(.*)$/:/^\s*[-*]\s+(.*)$/;return t.split(`
`).map(o=>o.match(n)).filter(o=>!!o).map(o=>S(o[1]))}function Ft(){const t=D("Chapter 4"),n=B(t,"4.3").split(`
`),o=[];let s=null;const i=()=>{var c,p,u,y,b;if(!s)return;const r=s.buf.join(`
`);let l=Q(r),h=[];if(l)h=s.buf.filter(m=>/^\*\*[^*]*flat/i.test(m.trim())).map(m=>S(m));else{const m=(c=r.match(/VALUE:\*\*\s*(.+)/i))==null?void 0:c[1],f=(p=r.match(/BLUFF:\*\*\s*(.+)/i))==null?void 0:p[1];if(m||f){const T=((y=(u=/\(\s*(BB|SB|BTN|CO)\s+only\s*\)/i.exec(s.label))==null?void 0:u[1])==null?void 0:y.toUpperCase())||"BB";l={headers:["Position","VALUE","BLUFF"],rows:[[T,S(m||""),S(f||"")]]};const N=(b=r.match(/Flat:\*\*\s*(.+)/i))==null?void 0:b[1];N&&(h=[`${T} flat: ${S(N)}`])}}l&&o.push({opener:zt(s.label),label:s.label,table:l,flats:h}),s=null};for(const r of n){const l=r.trim().match(/^\*\*(vs\s.+?open.*?)\*\*$/i);l?(i(),s={label:l[1],buf:[]}):s&&s.buf.push(r)}return i(),o}function zt(t){return t.replace(/^vs\s+/i,"").split(/\s+open/i)[0].trim().replace(/\s*\/\s*/g,"/")}function cn(){const t=D("Quick Reference");return{decisionOrder:he(B(t,"Decision order"),!0),sizes:Q(B(t,"Sizes")),band2530:Q(B(t,"25")),postflop:Q(B(t,"Postflop")),icm:Q(B(t,"ICM")),multiway:Q(B(t,"Multiway")),tilt:Q(B(t,"Tilt")),redFlags:he(B(t,"Red flags"),!1)}}function dn(){const t=D("Chapter 10");return Xe(t).map(a=>({title:a.title,questions:he(a.body,!0)})).filter(a=>a.questions.length>0)}function O(t,a){const n=D(t),o=a?B(n,a):n;return Q(o)}function un(){const t=O("Chapter 5","5.1");return t?t.rows.map(a=>({position:a[0],range:a[1]})):[]}function pn(){const t=O("Chapter 5","5.2");return t?t.rows.map(a=>({vs:a[0],range:a[1]})):[]}function bn(){const a=B(D("Chapter 5"),"5.3").match(/all-in:\s*([^.]+)\./);return a?S(a[1]):""}function fn(){const t=O("Chapter 4","4.5");if(!t)return null;const a=c=>{const p=t.rows.find(u=>u[0].toLowerCase().startsWith(c));return p?p[1]:""},n=c=>c.split(/[—;:]/)[0].trim(),o=n(a("4-bet value")),s=n(a("4-bet mixed")),i=n(a("4-bet bluff")),r=n(a("flat")),l=a("fold"),h=s?s.split(",").map(c=>`${c.trim()} (mixed)`).join(", "):"";return{value:h?`${o}, ${h}`:o,blof:i,flat:r,foldNote:l}}function mn(){const t=B(D("Chapter 4"),"4.6"),a=t.match(/VALUE:\*\*\s*(.+)/i),n=t.match(/BLUFF:\*\*\s*(.+)/i);return!a&&!n?null:{value:a?S(a[1]):"",blof:n?S(n[1]):""}}function yn(){return O("Chapter 4","4.7")}function gn(){return O("Chapter 14","14.1")}function wn(){const a=B(D("Chapter 14"),"14.1").match(/\*\*Rule:\*\*\s*(.+)/);return a?S(a[1]):""}function vn(){return O("Chapter 11","11.1")}function xn(){return O("Chapter 6","6.2")}function kn(){return O("Chapter 11","11.2")}function Tn(){return O("Chapter 11","11.3")}function jn(){return he(B(D("Chapter 11"),"11.4"),!1)}function An(){return O("Chapter 13","13.1")}function Bn(){return O("Chapter 15","15.2")}const Ht=[[/\bcheck-?raise\b/gi,"check raise"],[/\bcheck-?call\b/gi,"check call"],[/\bcheck-?fold\b/gi,"check fold"],[/\bstack-?off\b/gi,"stack off"],[/\bsemi-?bluff\b/gi,"semi bluff"],[/\bbluff-?catcher\b/gi,"bluff catcher"],[/\bcoldcall\b/gi,"cold call"],[/\bcbet\b/gi,"c bet"],[/\b5-?bet\b/gi,"five bet"],[/\b4-?bet\b/gi,"four bet"],[/\b3-?bet\b/gi,"three bet"],[/(\d)\s?bb\b/gi,"$1 big blind"],[/\bOOP\b/g,"O O P"],[/\bIP\b/g,"I P"],[/\bICM\b/g,"I C M"],[/\bPLO\b/g,"P L O"],[/\bNLH\b/g,"N L H"],[/\bBB\b/g,"big blind"],[/\bSB\b/g,"small blind"],[/\bBTN\b/g,"button"],[/\bUTG\b/g,"U T G"],[/\bbluff\b/gi,"bluff"],[/\bvalue\b/gi,"value"],[/\bboard\b/gi,"board"],[/\bflat\b/gi,"flat"],[/\bflop\b/gi,"flop"],[/\briver\b/gi,"river"],[/\bturn\b/gi,"turn"],[/\bcall\b/gi,"call"],[/\braise\b/gi,"raise"],[/\bsqueeze\b/gi,"squeeze"],[/\bgutshot\b/gi,"gutshot"],[/\brakeback\b/gi,"rakeback"],[/\bstack\b/gi,"stack"],[/\bbubble\b/gi,"bubble"],[/\bnut\b/gi,"nut"],[/\bkicker\b/gi,"kicker"],[/\brundown\b/gi,"rundown"],[/\bdangler\b/gi,"dangler"],[/\bwrap\b/gi,"wrap"],[/\bstation\b/gi,"station"],[/\bshowdown\b/gi,"showdown"],[/\bequity\b/gi,"equity"]];function Yt(t){let a=t;for(const[n,o]of Ht)a=a.replace(n,o);return a}class $t{constructor(){H(this,"supported",typeof window<"u"&&"speechSynthesis"in window);H(this,"voice",null);this.supported&&(this.pickVoice(),window.speechSynthesis.onvoiceschanged=()=>this.pickVoice())}pickVoice(){const a=window.speechSynthesis.getVoices();this.voice=a.find(n=>n.lang==="en-US")||a.find(n=>n.lang.startsWith("en"))||null}speak(a,n=1){return this.supported?(window.speechSynthesis.cancel(),new Promise(o=>{const s=new SpeechSynthesisUtterance(Yt(a));s.lang="en-US",this.voice&&(s.voice=this.voice),s.rate=n,s.pitch=1,s.onend=()=>o(),s.onerror=()=>o(),window.speechSynthesis.speak(s)})):Promise.resolve()}stop(){this.supported&&window.speechSynthesis.cancel()}}function Le(){return localStorage.getItem("ept:tts:mode")||"hd"}function Nn(t){localStorage.setItem("ept:tts:mode",t)}function Ut(t){let a=5381;for(let n=0;n<t.length;n++)a=a*33^t.charCodeAt(n);return"a"+(a>>>0).toString(36)}function Ze(){return new Promise((t,a)=>{const n=indexedDB.open("ept-tts",1);n.onupgradeneeded=()=>n.result.createObjectStore("audio"),n.onsuccess=()=>t(n.result),n.onerror=()=>a(n.error)})}async function _t(t){try{const a=await Ze();return await new Promise(n=>{const o=a.transaction("audio").objectStore("audio").get(t);o.onsuccess=()=>n(o.result||null),o.onerror=()=>n(null)})}catch{return null}}async function Vt(t,a){try{(await Ze()).transaction("audio","readwrite").objectStore("audio").put(a,t)}catch{}}async function Gt(t){try{const n=await fetch(`${typeof import.meta<"u"&&"/ept-trainer-en/"||"/"}tts/${t}.mp3`);if(!n.ok)return null;const o=await n.blob();return o.size<256||o.type&&!/audio|mpeg|octet/.test(o.type)?null:o}catch{return null}}async function et(t){const a=Ut("v1|"+t);let n=await _t(a);if(n)return n;if(n=await Gt(a),!n)try{const o=await fetch("/api/tts",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({text:t})});o.ok&&(n=await o.blob())}catch{}return n&&Vt(a,n),n}class Xt{constructor(){H(this,"web",new $t);H(this,"audio",null)}get supported(){return this.web.supported||Le()==="hd"}stopAudio(){this.audio&&(this.audio.pause(),this.audio.src="",this.audio=null)}async speak(a,n=1){if(Le()!=="hd")return this.web.speak(a,n);const o=await et(a);if(!o)return this.web.speak(a,n);await new Promise(s=>{this.stopAudio();const i=new Audio(URL.createObjectURL(o));i.playbackRate=n,i.onended=()=>s(),i.onerror=()=>s(),this.audio=i,i.play().catch(()=>s())})}stop(){this.stopAudio(),this.web.stop()}}let ye=null;function Zt(){return ye||(ye=new Xt),ye}function ea(t){return(t.match(/[^.!?]+[.!?]*/g)||[t]).map(a=>a.trim()).filter(Boolean)}async function ta(t,a){let n=0,o=0;const s=t.length;for(let i=0;i<t.length;i++)await et(t[i])?n++:o++,a==null||a(i+1,s);return{ok:n,fail:o}}function aa({table:t}){return e.jsx("div",{className:"overflow-x-auto rounded-xl border border-surface-3",children:e.jsxs("table",{className:"w-full text-sm",children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-surface-2 text-left text-neutral-300",children:t.headers.map((a,n)=>e.jsx("th",{className:"px-3 py-2 font-medium",children:a},n))})}),e.jsx("tbody",{children:t.rows.map((a,n)=>e.jsx("tr",{className:"border-t border-surface-3 align-top",children:a.map((o,s)=>e.jsx("td",{className:s===0?"px-3 py-2 font-semibold text-neutral-100 whitespace-nowrap":"px-3 py-2 text-neutral-300",children:o},s))},n))})]})})}const R=["A","K","Q","J","T","9","8","7","6","5","4","3","2"],C=Object.fromEntries(R.map((t,a)=>[t,a]));function na(t,a){const n=R[Math.min(t,a)],o=R[Math.max(t,a)];return t===a?`${n}${o}`:t<a?`${n}${o}s`:`${n}${o}o`}function oa(t,a){return C[t]<=C[a]?[t,a]:[a,t]}function ge(t){const a=t.trim().replace(/[–—]/g,"-").replace(/\s+/g,"");if(!a)return[];const n="[AKQJT98765432]";let o=a.match(new RegExp(`^(${n})\\1\\+$`));if(o){const s=[];for(let i=0;i<=C[o[1]];i++)s.push(`${R[i]}${R[i]}`);return s}if(o=a.match(new RegExp(`^(${n})\\1-(${n})\\2$`)),o){const[s,i]=[C[o[1]],C[o[2]]],r=[];for(let l=Math.min(s,i);l<=Math.max(s,i);l++)r.push(`${R[l]}${R[l]}`);return r}if(o=a.match(new RegExp(`^(${n})\\1$`)),o)return[`${o[1]}${o[1]}`];if(o=a.match(new RegExp(`^(${n})(${n})(s|o)\\+$`)),o){const[s,i,r]=[o[1],o[2],o[3]];if(C[s]>=C[i])return null;const l=[];for(let h=C[s]+1;h<=C[i];h++)l.push(`${s}${R[h]}${r}`);return l}if(o=a.match(new RegExp(`^(${n})(${n})(s|o)-(${n})(${n})(s|o)$`)),o){const[s,i,r,l,h,c]=[o[1],o[2],o[3],o[4],o[5],o[6]];if(s!==l||r!==c)return null;const p=[];for(let u=Math.min(C[i],C[h]);u<=Math.max(C[i],C[h]);u++)p.push(`${s}${R[u]}${r}`);return p}if(o=a.match(new RegExp(`^(${n})(${n})(s|o)$`)),o){const[s,i]=oa(o[1],o[2]);return[`${s}${i}${o[3]}`]}return null}function we(t,a){const n=new Set,o=[];if(!t)return{cells:n,notes:o};let s=t.trim();const i="[AKQJT98765432]";s=s.replace(new RegExp(`(${i}${i}[so]?)\\s*\\(\\s*mixed\\s*\\)`,"gi"),(r,l)=>{var h;return(h=ge(l))==null||h.forEach(c=>a==null?void 0:a.add(c))," "}),s=s.replace(new RegExp(`\\(\\s*(${i}${i}?[so]?)\\s*mixed\\s*\\)`,"gi"),(r,l)=>{var h;return(h=ge(l))==null||h.forEach(c=>a==null?void 0:a.add(c))," "}),s=s.replace(/\([^)]*\)/g," ");for(const r of s.split(",")){const l=r.trim().replace(/\.$/,"");if(!l||/^(none|yok|—|-)$/i.test(l))continue;const h=ge(l);h?h.forEach(c=>n.add(c)):(/[a-zçğıöşü]/i.test(l)&&l.length>3||l.length>1)&&o.push(l)}return{cells:n,notes:o}}const sa={value:"bg-emerald-500 text-black font-semibold",mix:"bg-emerald-500/35 text-emerald-50 ring-1 ring-inset ring-emerald-400/70",blof:"bg-accent text-black font-semibold",flat:"bg-sky-600 text-white",fold:"bg-surface-2 text-neutral-600"};function tt({value:t,blof:a,flat:n,caption:o,compact:s,highlight:i,valueLabel:r,blofLabel:l}){const{catOf:h,notes:c}=d.useMemo(()=>{const b=new Set,m=we(t||"",b),f=we(a||""),T=we(n||""),N=[...m.notes,...f.notes,...T.notes];return{catOf:k=>m.cells.has(k)?"value":b.has(k)?"mix":f.cells.has(k)?"blof":T.cells.has(k)?"flat":"fold",notes:N}},[t,a,n]),p=[];for(let b=0;b<13;b++)for(let m=0;m<13;m++){const f=na(b,m);p.push({code:f,label:R[Math.min(b,m)]+R[Math.max(b,m)],cat:h(f),pair:b===m})}const u=b=>p.some(m=>m.cat===b),y=s?"text-[7px]":"text-[9px] sm:text-[11px]";return e.jsxs("div",{children:[e.jsx("div",{className:"grid gap-[2px] rounded-lg bg-surface-3 p-[2px]",style:{gridTemplateColumns:"repeat(13, minmax(0, 1fr))"},children:p.map(b=>e.jsx("div",{title:b.code,className:"flex aspect-square items-center justify-center rounded-[3px] leading-none "+y+" "+sa[b.cat]+(i&&b.code===i?" ring-2 ring-white ring-offset-1 ring-offset-surface-3 z-10 scale-110":b.pair?" ring-1 ring-inset ring-white/25":""),children:b.label},b.code))}),e.jsxs("div",{className:"mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[11px] text-neutral-300",children:[u("value")&&e.jsx(ae,{cls:"bg-emerald-500",label:r||"Value 3-bet"}),u("mix")&&e.jsx(ae,{cls:"bg-emerald-500/35 ring-1 ring-inset ring-emerald-400/70",label:"Mixed"}),u("blof")&&e.jsx(ae,{cls:"bg-accent",label:l||"Bluff 3-bet"}),u("flat")&&e.jsx(ae,{cls:"bg-sky-600",label:"Flat (call)"})]}),o&&e.jsx("p",{className:"mt-2 text-xs text-neutral-500",children:o}),c.length>0&&e.jsxs("p",{className:"mt-1 text-xs text-neutral-400",children:[e.jsx("span",{className:"text-neutral-500",children:"+ book note:"})," ",c.join(", ")]})]})}function ae({cls:t,label:a}){return e.jsxs("span",{className:"inline-flex items-center gap-1.5",children:[e.jsx("span",{className:"inline-block h-3 w-3 rounded-[3px] "+t}),a]})}const ia={A:14,K:13,Q:12,J:11,T:10,9:9,8:8,7:7,6:6,5:5,4:4,3:3,2:2},De={s:"♠",h:"♥",d:"♦",c:"♣"};function ra(t){const a=t.trim().split(/[\s,]+/).map(c=>c.match(/^([AKQJT2-9])([shdc])$/i)).filter(Boolean).map(c=>({r:ia[c[1].toUpperCase()],s:c[2].toLowerCase()}));if(a.length<3)return[];const n=[],o={};for(const c of a)o[c.s]=(o[c.s]||0)+1;const[s,i]=Object.entries(o).sort((c,p)=>p[1]-c[1])[0];i>=3?n.push({label:`three ${De[s]} — flush board`,wet:!0}):i===2?n.push({label:`two ${De[s]} — flush draw`,wet:!0}):n.push({label:"rainbow",wet:!1});const r={};for(const c of a)r[c.r]=(r[c.r]||0)+1;Object.values(r).some(c=>c>=2)&&n.push({label:"paired",wet:!1});const l=[...new Set(a.map(c=>c.r))].sort((c,p)=>c-p),h=l[l.length-1]-l[0];return h<=4?n.push({label:"connected — straighty",wet:!0}):h>=7&&n.push({label:"dry",wet:!1}),n}const qe=new Set(["A","K","Q","J","T","9","8","7","6","5","4","3","2"]),Qe={s:{sym:"♠",red:!1},h:{sym:"♥",red:!0},d:{sym:"♦",red:!0},c:{sym:"♣",red:!1}},at={sm:{w:34,r:12,big:18},md:{w:46,r:15,big:26},lg:{w:64,r:20,big:38}};function xe({rank:t,suit:a,size:n="md"}){const o=Qe[a]||Qe.s,s=at[n],i=o.red?"#e5484d":"#141414";return e.jsxs("div",{className:"relative inline-flex shrink-0 flex-col items-center justify-center rounded-lg bg-white shadow-md",style:{width:s.w,height:Math.round(s.w*1.4)},children:[e.jsx("span",{className:"absolute left-1 top-0.5 font-bold leading-none",style:{fontSize:s.r,color:i},children:t}),e.jsx("span",{style:{fontSize:s.big,color:i,lineHeight:1},children:o.sym})]})}function la({size:t="md"}){const a=at[t];return e.jsx("div",{className:"inline-flex shrink-0 items-center justify-center rounded-lg border border-surface-3 bg-surface-2 text-neutral-500",style:{width:a.w,height:Math.round(a.w*1.4),fontSize:a.r},title:"not specified in the book",children:"?"})}function ha(t){return t.length>=3&&t[2]==="s"?["s","s"]:t.length>=3&&t[2]==="o"?["s","h"]:["s","h"]}function ca({code:t,size:a="md"}){const n=t.trim(),[o,s]=[n[0],n[1]],[i,r]=ha(n),l=n[2]==="s",h=n[2]==="o";return e.jsxs("span",{className:"inline-flex items-end gap-1.5",children:[e.jsxs("span",{className:"flex gap-1",children:[e.jsx(xe,{rank:o,suit:i,size:a}),e.jsx(xe,{rank:s,suit:r,size:a})]}),(l||h)&&e.jsx("span",{className:"mb-1 rounded px-1.5 py-0.5 text-[10px] font-semibold "+(l?"bg-emerald-500/20 text-emerald-300":"bg-neutral-500/20 text-neutral-300"),children:l?"suited":"offsuit"})]})}function J({spec:t,size:a="md",label:n,texture:o}){const s=t.trim().split(/[\s,]+/).filter(Boolean),i=o?ra(t):[];return e.jsxs("div",{children:[n&&e.jsx("div",{className:"mb-1 text-xs uppercase tracking-wide text-neutral-500",children:n}),e.jsx("div",{className:"flex flex-wrap items-end gap-1.5",children:s.map((r,l)=>{if(r==="??"||r==="?")return e.jsx(la,{size:a},l);if(r.length>=2&&qe.has(r[0])&&qe.has(r[1]))return e.jsx(ca,{code:r,size:a},l);const h=r.match(/^([AKQJT2-9])([shdc])$/i);return h?e.jsx(xe,{rank:h[1].toUpperCase(),suit:h[2].toLowerCase(),size:a},l):e.jsx("span",{className:"text-sm text-neutral-500",children:r},l)})}),i.length>0&&e.jsx("div",{className:"mt-1.5 flex flex-wrap gap-1.5",children:i.map((r,l)=>e.jsx("span",{className:"rounded-full px-2 py-0.5 text-[11px] "+(r.wet?"bg-accent-soft text-accent":"bg-surface-2 text-neutral-400"),children:r.label},l))})]})}function da({data:t}){const[a,n]=d.useState(0),o=t.streets.slice(0,a+1).map(i=>i.add).filter(Boolean).join(" "),s=t.streets[a];return e.jsxs("div",{className:"card p-4",children:[e.jsxs("div",{className:"mb-3 flex items-center justify-between",children:[e.jsx("span",{className:"text-sm font-semibold text-neutral-100",children:"🎬 Case replay"}),e.jsxs("span",{className:"text-xs text-neutral-500",children:[a+1,"/",t.streets.length," · ",s.name]})]}),o?e.jsx(J,{spec:o,size:"md",label:"Board",texture:!0}):e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-600",children:"Board (preflop)"}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-4",children:[e.jsx(J,{spec:t.hero,size:"sm",label:t.heroLabel??"You"}),t.villain&&e.jsx(J,{spec:t.villain,size:"sm",label:t.villainLabel??"Villain"})]}),e.jsx("p",{className:"mt-3 rounded-lg bg-surface-2 px-3 py-2 text-sm leading-relaxed text-neutral-200",children:s.note}),e.jsxs("div",{className:"mt-3 flex items-center gap-2",children:[e.jsx("button",{onClick:()=>n(i=>Math.max(0,i-1)),disabled:a===0,className:"btn-ghost px-3 py-1.5 text-sm",children:"← Back"}),e.jsx("button",{onClick:()=>n(i=>Math.min(t.streets.length-1,i+1)),disabled:a===t.streets.length-1,className:"btn-accent px-3 py-1.5 text-sm",children:"Next street →"})]})]})}function ua({v:t}){switch(t.kind){case"hand":return e.jsx(J,{spec:t.cards,size:t.size||"lg",label:t.label});case"board":return e.jsx(J,{spec:t.cards,size:t.size||"md",label:t.label??"Board",texture:!0});case"range":return e.jsx(tt,{value:t.value,blof:t.blof,flat:t.flat,caption:t.caption,compact:t.compact,valueLabel:t.valueLabel,blofLabel:t.blofLabel});case"replay":return e.jsx(da,{data:t.replay})}}function pa({items:t}){return!t||t.length===0?null:e.jsx("div",{className:"space-y-4",children:t.map((a,n)=>e.jsx(ua,{v:a},n))})}function ba(){const t=d.useMemo(()=>Ft(),[]),[a,n]=d.useState(0),[o,s]=d.useState(0);if(t.length===0)return e.jsx("p",{className:"text-sm text-neutral-400",children:"Couldn't load range groups."});const i=t[a];return e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("div",{className:"mb-1 text-xs uppercase tracking-wide text-neutral-500",children:"Who opened?"}),e.jsx("div",{className:"flex flex-wrap gap-2",children:t.map((r,l)=>e.jsx("button",{onClick:()=>{n(l),s(0)},className:l===a?"btn-accent px-3 py-1.5 text-sm":"btn-ghost px-3 py-1.5 text-sm",children:r.opener},l))})]}),e.jsx("div",{className:"text-xs text-neutral-500",children:i.label}),e.jsx("div",{className:"overflow-hidden rounded-xl border border-surface-3",children:e.jsxs("table",{className:"w-full text-sm",children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-surface-2 text-left text-neutral-300",children:i.table.headers.map((r,l)=>e.jsx("th",{className:"px-3 py-2 font-medium",children:r},l))})}),e.jsx("tbody",{children:i.table.rows.map((r,l)=>{const h=l===o;return e.jsx("tr",{onClick:()=>s(h?null:l),className:"cursor-pointer border-t border-surface-3 align-top transition "+(h?"bg-accent-soft ring-1 ring-accent":"hover:bg-surface-2"),children:r.map((c,p)=>e.jsx("td",{className:p===0?"px-3 py-2 font-semibold text-neutral-100 whitespace-nowrap":"px-3 py-2 "+(h?"text-neutral-100":"text-neutral-300"),children:c},p))},l)})})]})}),e.jsx("p",{className:"text-xs text-neutral-500",children:"Tap your position — your value and bluff ranges light up on the 13×13 grid."}),o!==null&&i.table.rows[o]&&e.jsxs("div",{className:"rounded-xl border border-surface-3 bg-surface-1 p-3",children:[e.jsxs("div",{className:"mb-2 text-sm font-semibold text-neutral-100",children:[i.table.rows[o][0]," · 3-bet range"]}),e.jsx(tt,{value:i.table.rows[o][1],blof:i.table.rows[o][2]})]}),i.flats.length>0&&e.jsx("ul",{className:"space-y-1 text-xs text-neutral-400",children:i.flats.map((r,l)=>e.jsxs("li",{children:["• ",r]},l))})]})}const $=Zt(),fa=[.8,1,1.25,1.5],ne=999;function ma(t){var a,n;return(((a=t.bullets)==null?void 0:a.length)??0)+((n=t.visuals)!=null&&n.length?1:0)+(t.table?1:0)+(t.rangeMatrix?1:0)+(t.ruleBox?1:0)}function ya({moduleId:t,onBack:a}){var Oe,Ie;const n=d.useMemo(()=>wt(t),[t]),[o,s]=d.useState(0),[i,r]=d.useState(!1),[l,h]=d.useState(!0),[c,p]=d.useState(1),[u,y]=d.useState(ne),[b,m]=d.useState(-1),[f,T]=d.useState({i:0,n:0}),[N,L]=d.useState(()=>{const g=$e[t];return g&&!E("coldopen:done",[]).includes(t)?g:null}),k=d.useRef(!1),M=d.useRef(c),G=d.useRef(l),pe=d.useRef(null);if(M.current=c,G.current=l,d.useEffect(()=>()=>{k.current=!1,$.stop()},[]),d.useEffect(()=>{if(b<0||!pe.current)return;const g=pe.current.querySelector('[data-active="true"]');g==null||g.scrollIntoView({block:"center",behavior:"smooth"})},[b]),!n)return e.jsxs("div",{className:"p-4",children:[e.jsx("button",{className:"btn-ghost",onClick:a,children:"← Back"}),e.jsx("p",{className:"mt-4 text-neutral-400",children:"Module not found."})]});if(N)return e.jsx(Tt,{kavram:N,onStart:()=>{const g=E("coldopen:done",[]);g.includes(t)||P("coldopen:done",[...g,t]),L(null)}});const q=n.slides,j=q[o],st=o===q.length-1;let X=((Oe=j.bullets)==null?void 0:Oe.length)??0;const Z=(Ie=j.visuals)!=null&&Ie.length?X++:-1,be=j.table?X++:-1,fe=j.rangeMatrix?X++:-1,ee=j.ruleBox?X++:-1,Y=g=>g>=0&&g<u,A=g=>i&&g===b,Ne=g=>{if(g!==q.length-1)return;const v=E("lessons:done",[]);v.includes(n.id)||P("lessons:done",[...v,n.id])},Ce=()=>{k.current=!1,$.stop(),r(!1),m(-1),y(ne)},it=async g=>{k.current=!0,r(!0);for(let v=g;v<q.length&&k.current;v++){s(v),Ne(v);const z=ea(q[v].narration),me=ma(q[v]);y(0),m(-1);for(let W=0;W<z.length&&k.current;W++){z[W+1]&&ta([z[W+1]]);const Pe=me===0?-1:Math.min(me-1,Math.floor(W/z.length*me));m(Pe),y(rt=>Math.max(rt,Pe+1)),T({i:W+1,n:z.length}),await $.speak(z[W],M.current)}if(y(ne),m(-1),!k.current||!G.current)break}k.current=!1,r(!1),T({i:0,n:0})},Se=g=>{Ce();const v=Math.min(Math.max(g,0),q.length-1);s(v),y(ne),Ne(v)},te=g=>"reveal-in transition-all duration-300 "+(i?g?"opacity-100":"opacity-40":"opacity-100");return e.jsxs("div",{className:"flex min-h-full flex-col",children:[e.jsxs("div",{className:"flex items-center gap-3 px-4 pt-4",children:[e.jsxs("button",{className:"btn-ghost px-3 py-1.5 text-sm",onClick:a,children:["← ",n.id]}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("div",{className:"truncate text-sm font-semibold",children:n.title}),e.jsxs("div",{className:"text-xs text-neutral-500",children:[n.chapter," · ",n.minutes," min"]})]})]}),e.jsx("div",{className:"flex gap-1 px-4 pt-3",children:q.map((g,v)=>e.jsx("div",{className:"h-1 flex-1 rounded-full "+(v<=o?"bg-accent":"bg-surface-3")},v))}),e.jsxs("div",{ref:pe,className:"flex-1 space-y-4 px-4 py-5",children:[e.jsx("h2",{className:"anim-fade text-xl font-bold",children:j.title}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("button",{onClick:()=>i?Ce():it(o),className:i?"btn-ghost":"btn-accent",disabled:!$.supported,children:i?"⏸ Stop":"▶ Play"}),e.jsxs("button",{onClick:()=>h(g=>!g),className:"btn px-3 py-2 text-sm "+(l?"bg-accent-soft text-accent border border-accent":"bg-surface-2 text-neutral-400 border border-surface-3"),title:"Auto-advance slides",children:["⟳ Auto ",l?"on":"off"]}),e.jsx("div",{className:"flex overflow-hidden rounded-xl border border-surface-3",children:fa.map(g=>e.jsxs("button",{onClick:()=>p(g),className:"min-h-[44px] px-3.5 py-2.5 text-xs "+(g===c?"bg-accent text-black":"bg-surface-2 text-neutral-400"),children:[g,"×"]},g))})]}),i&&f.n>0&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"live-pulse text-xs text-accent",children:"● narrating"}),e.jsx("div",{className:"h-1 flex-1 overflow-hidden rounded-full bg-surface-3",children:e.jsx("div",{className:"h-full rounded-full bg-accent transition-all duration-300",style:{width:`${f.i/f.n*100}%`}})})]}),!$.supported&&e.jsx("p",{className:"text-xs text-neutral-500",children:"This browser doesn't support voice narration."}),j.bullets&&e.jsx("ul",{className:"space-y-2",children:j.bullets.map((g,v)=>Y(v)?e.jsxs("li",{"data-active":A(v),className:"reveal-in flex gap-2 rounded-lg px-2 py-1 text-[15px] leading-relaxed transition-all duration-300 "+(A(v)?"bg-accent-soft ring-1 ring-accent/40":i?"opacity-40":""),children:[e.jsx("span",{className:"mt-1 "+(A(v)?"text-accent":"text-accent/70"),children:A(v)?"▶":"•"}),e.jsx("span",{children:g})]},v):null)}),j.visuals&&Y(Z)&&e.jsx("div",{"data-active":A(Z),className:te(A(Z))+(A(Z)?" rounded-xl ring-1 ring-accent/30 -mx-1 px-1 py-1":""),children:e.jsx(pa,{items:j.visuals})}),j.table&&Y(be)&&e.jsx("div",{"data-active":A(be),className:te(A(be)),children:e.jsx(ga,{table:j.table})}),j.rangeMatrix&&Y(fe)&&e.jsx("div",{"data-active":A(fe),className:te(A(fe)),children:e.jsx(ba,{})}),j.ruleBox&&Y(ee)&&e.jsxs("div",{"data-active":A(ee),className:te(A(ee))+" rounded-xl border-l-4 border-accent bg-accent-soft px-4 py-3 text-[15px] font-medium leading-relaxed"+(A(ee)?" ring-1 ring-accent/50":""),children:["📌 ",j.ruleBox]})]}),e.jsxs("div",{className:"flex items-center justify-between gap-3 px-4 pb-4",children:[e.jsx("button",{className:"btn-ghost",onClick:()=>Se(o-1),disabled:o===0,children:"← Previous"}),e.jsxs("span",{className:"text-xs text-neutral-500",children:[o+1," / ",q.length]}),st?e.jsx("button",{className:"btn-accent",onClick:a,children:"Finish ✓"}):e.jsx("button",{className:"btn-accent",onClick:()=>Se(o+1),children:"Next →"})]})]})}function ga({table:t}){const a=d.useMemo(()=>O(t.section,t.sub),[t.section,t.sub]);return e.jsxs("div",{className:"space-y-2",children:[a?e.jsx(aa,{table:a}):e.jsx("p",{className:"text-sm text-neutral-500",children:"Couldn't load the table."}),t.caption&&e.jsx("p",{className:"text-xs italic text-neutral-500",children:t.caption})]})}function wa({onDone:t}){const a=d.useMemo(()=>Be(),[]),[n,o]=d.useState(0),[s,i]=d.useState(!1),[r,l]=d.useState(0);if(a.length===0)return e.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-4xl",children:"👍"}),e.jsx("p",{className:"text-neutral-300",children:"Nothing due for review today."}),e.jsx("button",{onClick:t,className:"btn-accent px-4 py-2",children:"Back to Progress"})]});if(n>=a.length)return e.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-4xl",children:"🎉"}),e.jsxs("p",{className:"text-neutral-200",children:["Today's review is done — ",r," topics."]}),e.jsx("button",{onClick:t,className:"btn-accent px-4 py-2",children:"Back to Progress"})]});const h=a[n];function c(p){Et(h.id,p),ue(),l(u=>u+1),i(!1),o(u=>u+1)}return e.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:t,className:"text-neutral-400",children:"← Progress"}),e.jsxs("span",{className:"text-neutral-500",children:[n+1," / ",a.length]})]}),e.jsx("div",{className:"h-1 overflow-hidden rounded bg-surface-2",children:e.jsx("div",{className:"h-full bg-accent transition-all",style:{width:`${n/a.length*100}%`}})}),e.jsxs("div",{className:"card min-h-[180px] p-5",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:Ot(h.kavram)}),e.jsx("p",{className:"mt-2 text-lg leading-relaxed text-neutral-100",children:h.soru_ozeti}),s&&e.jsxs("div",{className:"mt-4 border-t border-surface-3 pt-3",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"Note / correct answer"}),e.jsxs("p",{className:"mt-1 text-sm text-neutral-300",children:[h.not||"—",e.jsxs("span",{className:"ml-2 text-neutral-500",children:["(last result: ",h.sonuc,")"]})]})]})]}),s?e.jsxs("div",{className:"grid grid-cols-3 gap-2",children:[e.jsx("button",{onClick:()=>c("wrong"),className:"btn-ghost py-3 text-red-300",children:"✗ Missed it"}),e.jsx("button",{onClick:()=>c("half"),className:"btn-ghost py-3 text-accent",children:"◐ Half"}),e.jsx("button",{onClick:()=>c("correct"),className:"btn-ghost py-3 text-emerald-300",children:"✓ Got it"})]}):e.jsx("button",{onClick:()=>i(!0),className:"btn-accent py-3 text-base",children:"Show"})]})}const va=[{n:11,short:"Bloated Pot · Turn · River"},{n:12,short:"ICM & Final Table"},{n:13,short:"Multiway Pot"},{n:14,short:"40–70bb Bridge"},{n:15,short:"PLO Tournament Layer"},{n:16,short:"Mental Spine"},{n:17,short:"WSOP Online ME Day 2 ★"}];function xa(t){const a=t.split(`
`),n=[];let o=[];const s=()=>{const r=o.join(" ").trim();r&&n.push({k:"p",text:r}),o=[]};let i=0;for(;i<a.length;){const r=a[i].trim();if(r===""||r==="---")s(),i++;else if(r.startsWith("### "))s(),n.push({k:"h3",text:r.slice(4).trim()}),i++;else if(r.startsWith("|")){s();const l=[];for(;i<a.length&&a[i].trim().startsWith("|");)l.push(a[i++].trim());const h=c=>c.replace(/^\|/,"").replace(/\|$/,"").split("|").map(p=>S(p));n.push({k:"table",headers:h(l[0]),rows:l.slice(2).map(h)})}else if(r.startsWith("> "))s(),n.push({k:"quote",text:r.slice(2).trim()}),i++;else if(/^([-*]|\d+\.)\s/.test(r)){s();const l=[];for(;i<a.length&&/^([-*]|\d+\.)\s/.test(a[i].trim());)l.push(a[i++].trim().replace(/^([-*]|\d+\.)\s/,""));n.push({k:"list",items:l})}else o.push(r),i++}return s(),n}function oe({text:t}){const a=t.split(/(\*\*[^*]+?\*\*|\*[^*]+?\*)/g).filter(Boolean);return e.jsx(e.Fragment,{children:a.map((n,o)=>n.startsWith("**")&&n.endsWith("**")?e.jsx("b",{children:n.slice(2,-2)},o):n.startsWith("*")&&n.endsWith("*")?e.jsx("i",{className:"text-neutral-400",children:n.slice(1,-1)},o):e.jsx("span",{children:n},o))})}function ka({title:t,onDone:a}){const n=d.useMemo(()=>xa(D(t)),[t]);return e.jsxs("div",{className:"flex flex-col gap-3 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:a,className:"text-neutral-400",children:"← Chapters"}),e.jsx("span",{className:"font-semibold text-neutral-100",children:"📖 Book"}),e.jsx("span",{className:"w-16"})]}),e.jsx("h1",{className:"text-base font-semibold leading-snug text-neutral-100",children:t}),n.map((o,s)=>o.k==="h3"?e.jsx("h2",{className:"mt-2 text-sm font-semibold text-accent",children:o.text},s):o.k==="quote"?e.jsx("blockquote",{className:"border-l-2 border-accent bg-accent-soft px-3 py-2 text-[13px] font-medium leading-relaxed text-accent",children:e.jsx(oe,{text:o.text})},s):o.k==="list"?e.jsx("ul",{className:"ml-1 space-y-1",children:o.items.map((i,r)=>e.jsxs("li",{className:"flex gap-2 text-[13px] leading-snug text-neutral-200",children:[e.jsx("span",{className:"shrink-0 text-accent",children:"•"}),e.jsx("span",{children:e.jsx(oe,{text:i})})]},r))},s):o.k==="table"?e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"w-full border-collapse text-[12px]",children:[e.jsx("thead",{children:e.jsx("tr",{children:o.headers.map((i,r)=>e.jsx("th",{className:"border border-surface-3 bg-surface-2 px-2 py-1 text-left font-semibold text-neutral-300",children:i},r))})}),e.jsx("tbody",{children:o.rows.map((i,r)=>e.jsx("tr",{children:i.map((l,h)=>e.jsx("td",{className:"border border-surface-3 px-2 py-1 align-top text-neutral-200",children:e.jsx(oe,{text:l})},h))},r))})]})},s):e.jsx("p",{className:"text-[13px] leading-relaxed text-neutral-300",children:e.jsx(oe,{text:o.text})},s))]})}const nt="leakcard:date";function Ta(){var a;const t=((a=Ge()[0])==null?void 0:a.kavram)||"";return/icm|cover/i.test(t)?"cover":"pot"}function ot(){return new Date().toISOString().slice(0,10)}function ja(){return E(nt,"")===ot()}function We(){const t=Math.random()<.45,a=4+Math.floor(Math.random()*60),n=8+Math.floor(Math.random()*90),o=a/(a+n),s=t||o>=.4;return{potBb:a,behindBb:n,threeBet:t,bloated:s}}function Aa(){const[t,a]=d.useState(ja()?"hidden":"card"),[n]=d.useState(()=>Ta()),o=d.useRef(null);if(d.useEffect(()=>{var i,r;t!=="hidden"&&((r=(i=o.current)==null?void 0:i.querySelector("button"))==null||r.focus())},[t]),t==="hidden")return null;const s=()=>{P(nt,ot()),ue(),a("hidden")};return e.jsx("div",{ref:o,role:"dialog","aria-modal":"true","aria-label":"Card of the day",onKeyDown:i=>{var c;if(i.key!=="Tab")return;const r=(c=o.current)==null?void 0:c.querySelectorAll("button, input, textarea, a[href]");if(!r||r.length===0)return;const l=r[0],h=r[r.length-1];i.shiftKey&&document.activeElement===l?(i.preventDefault(),h.focus()):!i.shiftKey&&document.activeElement===h&&(i.preventDefault(),l.focus())},className:"fixed inset-0 z-50 flex flex-col bg-surface-0/95 backdrop-blur",children:e.jsx("div",{className:"mx-auto flex h-full w-full max-w-md flex-col",children:t==="card"?n==="cover"?e.jsx(Na,{onDrill:()=>a("drill"),onDone:s}):e.jsx(Ba,{onDrill:()=>a("drill"),onDone:s}):n==="cover"?e.jsx(Ca,{onDone:s}):e.jsx(Sa,{onDone:s})})})}function Ba({onDrill:t,onDone:a}){return e.jsxs("div",{className:"flex flex-1 flex-col justify-center gap-6 p-6",children:[e.jsx("div",{className:"text-center text-xs uppercase tracking-[0.2em] text-accent",children:"Card of the day"}),e.jsx("div",{className:"card border-l-4 border-accent p-6",children:e.jsxs("p",{className:"text-lg leading-relaxed",children:[e.jsx("b",{className:"text-accent",children:"IF"})," the pot is bloated (a 3-bet+ pot or ~40% of my stack in the middle)"," ",e.jsx("b",{className:"text-accent",children:"AND"})," I hold one pair,",e.jsx("br",{}),e.jsx("b",{className:"text-accent",children:"THEN"})," I tell myself ",e.jsx("b",{children:'"bluff-catcher"'}),": check/call or fold —"," ",e.jsx("b",{children:"never a value raise."})]})}),e.jsx("p",{className:"text-center text-[11px] text-neutral-600",children:"The book's definition: bloated = 3-bet+ pot. “~40% of stack in the middle” is a practical heuristic (beyond the book)."}),e.jsx("p",{className:"text-center text-sm text-neutral-500",children:"Read it out loud once. At the table this sentence will fire on its own."}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("button",{onClick:a,className:"btn-accent w-full py-3 text-base",children:"Rehearsed ✓"}),e.jsx("button",{onClick:t,className:"btn-ghost w-full py-3",children:"⏱ 90s cue drill →"})]})]})}function Na({onDrill:t,onDone:a}){return e.jsxs("div",{className:"flex flex-1 flex-col justify-center gap-6 p-6",children:[e.jsx("div",{className:"text-center text-xs uppercase tracking-[0.2em] text-accent",children:"Card of the day"}),e.jsx("div",{className:"card border-l-4 border-accent p-6",children:e.jsxs("p",{className:"text-lg leading-relaxed",children:[e.jsx("b",{className:"text-accent",children:"IF"})," I'm about to press fold to a jam,",e.jsx("br",{}),e.jsx("b",{className:"text-accent",children:"THEN"})," I classify first: ",e.jsx("b",{children:"does it cover me, or do I cover it?"})," Not covered → ",e.jsx("b",{children:"the call is much wider."})]})}),e.jsx("p",{className:"text-center text-[11px] text-neutral-600",children:"The book (C12): an uncovered range is never tighter than a covered one — even if you lose, you don't bust."}),e.jsx("p",{className:"text-center text-sm text-neutral-500",children:"Read it out loud once. At the table this sentence will fire on its own."}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("button",{onClick:a,className:"btn-accent w-full py-3 text-base",children:"Rehearsed ✓"}),e.jsx("button",{onClick:t,className:"btn-ghost w-full py-3",children:"⏱ 90s cue drill →"})]})]})}const I=12;function Je(){const t=12+Math.floor(Math.random()*60),a=3+Math.floor(Math.random()*40),n=Math.random()<.5?t+a:Math.max(3,t-a);return{heroBb:t,jammerBb:n,covered:n>=t}}function Ca({onDone:t}){const[a,n]=d.useState(0),[o,s]=d.useState(()=>Je()),[i,r]=d.useState(null),[l,h]=d.useState(0),c=i===o.covered,p=a>=I;function u(b){r(b),b===o.covered&&h(m=>m+1)}function y(){if(a+1>=I){n(I);return}n(b=>b+1),s(Je()),r(null)}return p?e.jsxs("div",{className:"flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-5xl",children:"🎯"}),e.jsxs("p",{className:"text-lg text-neutral-100",children:[l,"/",I," correct"]}),e.jsx("p",{className:"text-sm text-neutral-500",children:"Before folding to a jam: am I covered? No → the call is much wider."}),e.jsx("button",{onClick:t,className:"btn-accent px-6 py-3",children:"Finish ✓"})]}):e.jsxs("div",{className:"flex flex-1 flex-col gap-5 p-6",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("span",{className:"text-neutral-500",children:"Cue drill"}),e.jsxs("span",{className:"text-neutral-400",children:[a+1," / ",I]})]}),e.jsxs("div",{className:"card p-5",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"rounded-full bg-accent-soft px-3 py-1 text-sm font-semibold text-accent",children:["You ",o.heroBb,"bb"]}),e.jsxs("span",{className:"text-sm text-neutral-400",children:["jammer ",o.jammerBb,"bb"]})]}),e.jsx("div",{className:"mt-3 text-sm text-neutral-400",children:"Bubble. The jam is on you."})]}),i===null?e.jsxs("div",{children:[e.jsx("div",{className:"mb-2 text-center text-[15px] font-medium",children:"Classify: this jam…"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx("button",{onClick:()=>u(!0),className:"btn-ghost py-4 text-base",children:"Covers me"}),e.jsx("button",{onClick:()=>u(!1),className:"btn-ghost py-4 text-base",children:"I cover it"})]})]}):e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx("div",{className:"rounded-xl px-4 py-3 text-sm font-medium "+(c?"bg-emerald-500/15 text-emerald-300":"bg-red-500/15 text-red-300"),children:o.covered?"You're covered — losing means bust. The call tightens hard.":"You're not covered — even if you lose, you don't bust. The call is much wider than you think."}),e.jsx("button",{onClick:y,className:"btn-accent py-3 text-base",children:a+1>=I?"Finish":"Next →"})]}),e.jsx("button",{onClick:t,className:"btn-ghost mt-auto w-full py-3",children:"skip"})]})}function Sa({onDone:t}){const[a,n]=d.useState(0),[o,s]=d.useState(()=>We()),[i,r]=d.useState("pot"),[l,h]=d.useState(null),[c,p]=d.useState(null),[u,y]=d.useState(0),b=l===o.bloated,m=c===o.bloated,f=b&&m,T=a>=I;function N(M){h(M),r("class")}function L(M){p(M),b&&M===o.bloated&&y(G=>G+1),r("fb")}function k(){if(a+1>=I){n(I);return}n(M=>M+1),s(We()),h(null),p(null),r("pot")}return T?e.jsxs("div",{className:"flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-5xl",children:"🎯"}),e.jsxs("p",{className:"text-lg text-neutral-100",children:[u,"/",I," correct"]}),e.jsx("p",{className:"text-sm text-neutral-500",children:"One pair in a bloated pot = bluff-catcher. Take this reflex to the table."}),e.jsx("button",{onClick:t,className:"btn-accent px-6 py-3",children:"Finish ✓"})]}):e.jsxs("div",{className:"flex flex-1 flex-col gap-5 p-6",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("span",{className:"text-neutral-500",children:"Cue drill"}),e.jsxs("span",{className:"text-neutral-400",children:[a+1," / ",I]})]}),e.jsxs("div",{className:"card p-5",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"rounded-full bg-accent-soft px-3 py-1 text-sm font-semibold text-accent",children:["Pot ",o.potBb,"bb"]}),e.jsxs("span",{className:"text-sm text-neutral-400",children:[o.behindBb,"bb behind"]})]}),o.threeBet&&e.jsx("div",{className:"mt-2 inline-block rounded-full bg-red-500/15 px-2 py-0.5 text-xs text-red-300",children:"3-bet pot"}),e.jsx("div",{className:"mt-3 text-sm text-neutral-400",children:"Your hand: one pair (overpair)"})]}),i==="pot"&&e.jsxs("div",{children:[e.jsx("div",{className:"mb-2 text-center text-[15px] font-medium",children:"Is the pot bloated?"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx("button",{onClick:()=>N(!0),className:"btn-ghost py-4 text-base",children:"Yes, bloated"}),e.jsx("button",{onClick:()=>N(!1),className:"btn-ghost py-4 text-base",children:"No"})]})]}),i==="class"&&e.jsxs("div",{children:[e.jsx("div",{className:"mb-2 text-center text-[15px] font-medium",children:"What class is your one pair?"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx("button",{onClick:()=>L(!0),className:"btn-ghost py-4 text-base",children:"Bluff-catcher"}),e.jsx("button",{onClick:()=>L(!1),className:"btn-ghost py-4 text-base",children:"Value"})]})]}),i==="fb"&&e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"rounded-xl px-4 py-3 text-sm font-medium "+(f?"bg-emerald-500/15 text-emerald-300":"bg-red-500/15 text-red-300"),children:[e.jsx("div",{children:o.bloated?"Bloated pot → one pair is a BLUFF-CATCHER.":"Not bloated → one pair is still value/showdown."}),!f&&e.jsx("div",{className:"mt-1 font-normal opacity-90",children:b?`Your pot read was right, the classification wrong: ${o.bloated?"bluff-catcher":"value/showdown"}.`:m?"Your classification was right, the pot read was wrong.":"Both the pot read and the classification were wrong."})]}),e.jsx("button",{onClick:k,className:"btn-accent py-3 text-base",children:a+1>=I?"Finish":"Next →"})]}),e.jsx("button",{onClick:t,className:"btn-ghost mt-auto w-full py-3",children:"skip"})]})}const U=[{id:"vaka1",title:"Case 1 — A4s river call",setup:"$50K High Roller. The board is prone to chopping — the chop mechanic is on the table. Villain moves all-in on the river. Your hand: A4s.",hero:"A4s",board:"",options:["Hero-call","Fold"],correct:1,rule:"Chops don't jam: if villain moves all-in, he has removed the chopping hands from his range — the jam is a hand that beats you. Spotting a mechanic isn't enough; ask whether villain's move is consistent with it. 📌 With a chop on board, a jam = a hand that has you beat.",selfExplain:"You spotted the chop mechanic — so which filter did you skip?",concept:"kök-hata"},{id:"vaka2",title:"Case 2 — KTo top pair",setup:"$10K 6-max. Wet board, you flopped top pair (KT). You're OOP, villain c-bets. Action on you.",hero:"KTo",board:"",options:["Check-raise all-in","Check-call, reassess later"],correct:1,rule:"One pair is not stack-off fuel. On a wet board, top pair does not start a big pot; when you start the stacks going in, the range that pays you has you beat. The road to a bloated pot turns your hand into a bluff-catcher. 📌 Top pair on a wet board: check-call, don't start it.",selfExplain:"Top pair looked strong — once the pot grew, what class did your hand become?",concept:"kök-hata"},{id:"vaka3",title:"Case 3 — AA river jam",setup:"Board 2-4-5, value bet on flop + turn (both were correct). The river is a 6 — no hand weaker than yours pays anymore. Your hand: AA. Villain checks.",hero:"AA",board:"2c 4d 5s ?? 6h",options:["Jam the remaining stack","Check"],correct:1,rule:"If no hand weaker than yours will call on the river, the jam is not value. On that river, trips/straights/sets have you beat and one pair folds — no value target. Overpair on a bad river: check-call a small pot, check-fold a big one. 📌 No weaker hand to pay you = no jam.",selfExplain:"Flop + turn value was correct — what exactly changed on the river 6?",concept:"kök-hata"},{id:"vaka4",title:"Case 4 — Your hand (yesterday)",setup:"6-max. T6s in the BB, BTN min-raises, you call. Flop A-T-3, BTN bets 1/3 pot, you call (pair of tens). Turn 5, check-check. River T → board A-T-3-5-T, you have trip tens but a 6 kicker. You checked, BTN makes a thin bet. Action on you.",hero:"Th 6h",board:"Ac Ts 3d 5c Td",options:["Check-raise all-in","Check-call — bluff-catcher"],correct:1,rule:"No hand weaker than yours calls the all-in: every ten beats your 6 kicker, and boats are ahead anyway. On this runout your trips are a bluff-catcher — check-call, keep the bluffs in. Check-raise all-in folds out the bluffs; only hands that beat you call. 📌 No weaker hand to pay you = no raise (sentence 2 = Case 2).",selfExplain:"Trip tens felt strong — on that board, how many hands BEAT your 6 kicker, and how many are BEHIND and pay?",concept:"kök-hata",beyondBook:!0}];function Oa({onBack:t}){const[a,n]=d.useState(0),[o,s]=d.useState(null),[i]=d.useState(()=>E("autopsy:done",!1)),r=U[a],l=o!==null,h=a>=U.length;function c(u){if(l||(s(u),i))return;const y=u===r.correct;ue(),Ve({kavram:r.concept,soru_ozeti:`Autopsy: ${r.title}`,sonuc:y?"correct":"wrong",not:r.rule,severity:"tournament_life"})}function p(){s(null),a+1>=U.length&&!i&&P("autopsy:done",!0),n(u=>u+1)}return h?e.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-5xl",children:"🔬"}),e.jsx("p",{className:"text-neutral-200",children:"Cases done. The root error was the same every time."}),e.jsx("p",{className:"text-sm text-neutral-500",children:"Misclassifying one pair in a bloated/multiway pot. Take this reflex to the table."}),e.jsx("button",{onClick:t,className:"btn-accent px-6 py-3",children:"← Back to lesson"})]}):e.jsxs("div",{className:"flex min-h-full flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:t,className:"text-neutral-400",children:"← Lesson"}),e.jsxs("span",{className:"text-neutral-500",children:[a+1," / ",U.length]})]}),i&&e.jsx("div",{className:"rounded-lg bg-surface-2 px-3 py-2 text-xs text-neutral-400",children:"Replay — not scored; focus on explaining it to yourself."}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("h1",{className:"text-xl font-bold",children:r.title}),r.beyondBook?e.jsx("span",{className:"rounded border border-dashed border-accent/50 bg-accent-soft px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-accent",children:"Beyond the book · your hand"}):e.jsx("span",{className:"rounded bg-emerald-500/15 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-emerald-300",children:"From the book · Chapter 7"})]}),e.jsxs("div",{className:"card p-4",children:[e.jsx("div",{className:"flex items-center justify-between gap-3",children:e.jsx(J,{spec:r.hero,size:"md",label:"Your hand"})}),r.board&&e.jsx("div",{className:"mt-3",children:e.jsx(J,{spec:r.board,size:"sm",label:"Board",texture:!0})}),e.jsx("p",{className:"mt-3 text-[15px] leading-relaxed text-neutral-200",children:r.setup})]}),l?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"rounded-xl px-4 py-3 text-sm font-medium "+(o===r.correct?"bg-emerald-500/15 text-emerald-300":"bg-red-500/15 text-red-300"),children:[o===r.correct?"✓ Correct — ":"✗ ","Correct line: ",e.jsx("b",{children:r.options[r.correct]})]}),e.jsx("div",{className:"rounded-xl border-l-4 border-accent bg-accent-soft px-4 py-3 text-sm leading-relaxed",children:r.rule}),e.jsxs("div",{className:"card p-3",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"Explain it to yourself"}),e.jsx("p",{className:"mt-1 text-sm text-neutral-300",children:r.selfExplain}),e.jsx("textarea",{rows:2,placeholder:"Out loud or in writing — which cue did you miss?",className:"mt-2 w-full resize-none rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"})]}),e.jsx(Pa,{hand:r},r.id),e.jsx("button",{onClick:p,className:"btn-accent py-3 text-base",children:a+1>=U.length?"Finish":"Next case →"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"text-center text-sm text-neutral-500",children:"YOU decide first:"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:r.options.map((u,y)=>e.jsx("button",{onClick:()=>c(y),className:"btn-ghost py-3 text-[15px]",children:u},y))})]})]})}function Ia(t){return t<1?0:t<=4?1:t<=8?2:3}function Pa({hand:t}){const[a,n]=d.useState(""),[o,s]=d.useState(""),[i,r]=d.useState(()=>{const p=E("spr-kalibrasyon",[]).find(u=>u.id===t.id);return p?p.spr:null}),l=d.useMemo(()=>O("Chapter 11","11.0"),[]);function h(){const p=Number(a),u=Number(o);if(!isFinite(p)||p<=0||!isFinite(u)||u<0)return;const y=Math.round(u/p*10)/10;r(y);const b=E("spr-kalibrasyon",[]).filter(m=>m.id!==t.id);P("spr-kalibrasyon",[...b,{id:t.id,pot:p,stack:u,spr:y}]),Ve({kavram:"spr-kalibrasyon",soru_ozeti:`Estimate SPR: ${t.title}`,sonuc:"correct",not:`flop pot ${p}bb, remaining stack ${u}bb → SPR ${y}`})}const c=i!==null&&l?l.rows[Ia(i)]:null;return e.jsxs("div",{className:"card p-3",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"Estimate SPR (C11.0 · optional)"}),e.jsx("p",{className:"mt-1 text-xs text-neutral-500",children:"From memory: the pot on the flop and the stack you had behind (bb). If you don't remember, leave it blank — never make numbers up."}),e.jsxs("div",{className:"mt-2 flex items-center gap-2",children:[e.jsx("input",{value:a,onChange:p=>n(p.target.value),inputMode:"decimal",placeholder:"flop pot (bb)",className:"w-full min-w-0 rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("input",{value:o,onChange:p=>s(p.target.value),inputMode:"decimal",placeholder:"stack behind (bb)",className:"w-full min-w-0 rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("button",{onClick:h,className:"btn-ghost shrink-0 px-3 py-2 text-sm",children:"Compute"})]}),i!==null&&e.jsxs("div",{className:"mt-3 text-sm",children:[e.jsxs("div",{className:"font-semibold text-accent",children:["SPR ≈ ",i]}),c?e.jsxs("div",{className:"mt-1 rounded-lg bg-surface-2 px-3 py-2 text-xs leading-relaxed text-neutral-300",children:[e.jsx("b",{children:c[0]})," · ",c[1]," → ",c[2]]}):e.jsx("p",{className:"mt-1 text-xs text-neutral-500",children:"Couldn't load the band table (C11.0)."})]})]})}const Fe="journal",Ma=[{v:.6,label:"60%"},{v:.8,label:"80%"},{v:.95,label:"95%"}];function Ra({onDone:t}){const[a,n]=d.useState(()=>E(Fe,[])),[o,s]=d.useState(""),[i,r]=d.useState(""),[l,h]=d.useState(""),[c,p]=d.useState(.8),[u,y]=d.useState(null),b=a.filter(f=>f.day===x(-1)).length;function m(){if(!o.trim()||!i.trim()){y({ok:!1,text:"Hand and Action are required — fill in both."});return}const f=[{day:x(0),el:o,aksiyon:i,gerekce:l,guven:c},...a];n(f),P(Fe,f),ue(),s(""),r(""),h(""),y({ok:!0,text:"Saved ✓"})}return e.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:t,className:"text-neutral-400",children:"← Progress"}),e.jsx("span",{className:"font-semibold text-neutral-100",children:"🗒 Decision journal"}),e.jsx("span",{className:"w-12"})]}),Ue()&&e.jsx("div",{className:"rounded-xl border border-accent/40 bg-accent-soft px-4 py-2.5 text-sm text-accent",children:"🥊 Cornerman mode on. Taper: drop the volume, keep the intensity. No late-night study — sleep loss amplifies tilt."}),e.jsx("p",{className:"text-sm text-neutral-500",children:"Write it before you know the result. Good decision, bad result = correct. The next day you grade the process, not the result."}),b>0&&e.jsxs("a",{href:"#/drill",className:"rounded-xl border border-accent/40 bg-accent-soft px-4 py-2.5 text-sm text-accent",children:["You brought ",b," hand",b>1?"s":""," back from the table yesterday → score them in Drill"]}),e.jsxs("div",{className:"card space-y-2 p-4",children:[e.jsx("input",{value:o,onChange:f=>s(f.target.value),placeholder:"Hand / spot (e.g. 42bb CO KQo, HJ opened)",className:"w-full rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("input",{value:i,onChange:f=>r(f.target.value),placeholder:"Action (fold / 3-bet 9bb / check-call…)",className:"w-full rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("textarea",{value:l,onChange:f=>h(f.target.value),rows:2,placeholder:"Reasoning (why?)",className:"w-full resize-none rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xs text-neutral-500",children:"Confidence:"}),Ma.map(f=>e.jsx("button",{onClick:()=>p(f.v),className:"rounded-full px-2.5 py-1 text-xs "+(c===f.v?"bg-accent text-black font-semibold":"bg-surface-2 text-neutral-400"),children:f.label},f.v)),e.jsx("button",{onClick:m,className:"btn-accent ml-auto px-4 py-2 text-sm",children:"Save"})]}),u&&e.jsx("div",{className:"text-xs "+(u.ok?"text-emerald-400":"text-red-400"),children:u.text})]}),a.length===0?e.jsx("p",{className:"text-center text-sm text-neutral-600",children:"No entries yet."}):e.jsx("div",{className:"space-y-2",children:a.map((f,T)=>e.jsxs("div",{className:"card p-3 text-sm",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"font-semibold text-neutral-100",children:f.el}),e.jsx("span",{className:"text-xs text-neutral-500",children:f.day})]}),e.jsxs("div",{className:"text-accent",children:[f.aksiyon," · ",Math.round(f.guven*100),"%"]}),f.gerekce&&e.jsx("div",{className:"mt-1 text-neutral-400",children:f.gerekce})]},T))})]})}const Ea=d.lazy(()=>K(()=>import("./Quiz-CxhkIHKa.js"),__vite__mapDeps([0,1,2])).then(t=>({default:t.Quiz}))),Ka=d.lazy(()=>K(()=>import("./Drill-Cy9yO4H7.js"),__vite__mapDeps([3,1,4])).then(t=>({default:t.Drill}))),La=d.lazy(()=>K(()=>import("./Simulator-BL31Foar.js"),__vite__mapDeps([5,1,4])).then(t=>({default:t.Simulator}))),Da=d.lazy(()=>K(()=>import("./Progress-CU_Ivfty.js"),__vite__mapDeps([6,1])).then(t=>({default:t.Progress}))),qa=d.lazy(()=>K(()=>import("./QuickReference-oOqyNi3p.js"),__vite__mapDeps([7,1])).then(t=>({default:t.QuickReference}))),Qa=d.lazy(()=>K(()=>import("./Sentences-ConvJITc.js"),__vite__mapDeps([8,1])).then(t=>({default:t.Sentences}))),Wa=d.lazy(()=>K(()=>import("./RangeAtlas-ZFGlO0Wg.js"),__vite__mapDeps([9,1,2])).then(t=>({default:t.RangeAtlas}))),Ja=d.lazy(()=>K(()=>import("./EquityIntuition-CbX1GhIJ.js"),__vite__mapDeps([10,1])).then(t=>({default:t.EquityIntuition}))),Fa=d.lazy(()=>K(()=>import("./BetTypes-C0TEq_U7.js"),__vite__mapDeps([11,1])).then(t=>({default:t.BetTypes}))),za=d.lazy(()=>K(()=>import("./QuestionBank-BfLjMcSW.js"),__vite__mapDeps([12,1])).then(t=>({default:t.QuestionBank}))),Ha=d.lazy(()=>K(()=>import("./IcmCard-9gwfPs-s.js"),__vite__mapDeps([13,1])).then(t=>({default:t.IcmCard})));function Ya(){const[t,a]=d.useState(()=>window.location.hash);return d.useEffect(()=>{const n=()=>a(window.location.hash);return window.addEventListener("hashchange",n),()=>window.removeEventListener("hashchange",n)},[]),t}function w(t){window.location.hash=t}const $a=[{id:"ders",label:"Lessons",icon:"📚"},{id:"quiz",label:"Quiz",icon:"🎯"},{id:"drill",label:"Drill",icon:"🃏"},{id:"ilerleme",label:"Progress",icon:"📊"},{id:"referans",label:"Reference",icon:"⚡"}];function Ua(){return e.jsx("div",{className:"flex h-full items-center justify-center text-sm text-neutral-500",children:"Loading…"})}function _a(){const a=Ya().replace(/^#\/?/,"").split("/").filter(Boolean),o=new Set(["ders","quiz","drill","ilerleme","referans"]).has(a[0])?a[0]:"ders",s=a[1],i=d.useRef(null),[r,l]=d.useState(!1);return d.useEffect(()=>{var h;(h=i.current)==null||h.scrollTo(0,0)},[a[0],a[1]]),d.useEffect(()=>{const h=()=>l(!0);return window.addEventListener("ept:storage-fail",h,{once:!0}),()=>window.removeEventListener("ept:storage-fail",h)},[]),e.jsxs("div",{className:"mx-auto flex h-[100dvh] max-w-md flex-col bg-surface-0 pt-[env(safe-area-inset-top)]",children:[e.jsx(Aa,{}),r&&e.jsxs("div",{className:"flex items-center justify-between gap-3 bg-red-900/80 px-4 py-2 text-[13px] text-red-100",children:[e.jsx("span",{children:"Can't save — storage full/restricted"}),e.jsx("button",{"aria-label":"Dismiss",className:"px-1 font-semibold",onClick:()=>l(!1),children:"✕"})]}),e.jsx("main",{ref:i,className:"flex-1 overflow-y-auto",children:e.jsxs(d.Suspense,{fallback:e.jsx(Ua,{}),children:[o==="ders"&&(s==="otopsi"?e.jsx(Oa,{onBack:()=>w("#/ders")}):s?e.jsx(ya,{moduleId:s,onBack:()=>w("#/ders")}):e.jsx(Qt,{onOpen:h=>w("#/ders/"+h)})),o==="quiz"&&e.jsx(Ea,{}),o==="drill"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex gap-2 px-4 pt-4",children:[e.jsx("button",{onClick:()=>w("#/drill"),className:"btn px-3 py-2 text-sm "+(a[1]!=="masa"?"bg-accent-soft text-accent border border-accent":"bg-surface-2 text-neutral-400 border border-surface-3"),children:"🃏 Question drill"}),e.jsx("button",{onClick:()=>w("#/drill/masa"),className:"btn px-3 py-2 text-sm "+(a[1]==="masa"?"bg-accent-soft text-accent border border-accent":"bg-surface-2 text-neutral-400 border border-surface-3"),children:"🎲 Table (hand sim)"})]}),a[1]==="masa"?e.jsx(La,{}):e.jsx(Ka,{})]}),o==="ilerleme"&&(a[1]==="tekrar"?e.jsx(wa,{onDone:()=>w("#/ilerleme")}):a[1]==="gunluk"?e.jsx(Ra,{onDone:()=>w("#/ilerleme")}):e.jsx(Da,{onReview:()=>w("#/ilerleme/tekrar"),onJournal:()=>w("#/ilerleme/gunluk")})),o==="referans"&&(a[1]==="cumleler"?e.jsx(Qa,{onDone:()=>w("#/referans")}):a[1]==="araliklar"?e.jsx(Wa,{onDone:()=>w("#/referans")}):a[1]==="equity"?e.jsx(Ja,{onDone:()=>w("#/referans")}):a[1]==="bahis"?e.jsx(Fa,{onDone:()=>w("#/referans")}):a[1]==="sorubankasi"?e.jsx(za,{onDone:()=>w("#/referans")}):a[1]==="icmkart"?e.jsx(Ha,{onDone:()=>w("#/referans")}):a[1]==="bolum"&&a[2]?e.jsx(ka,{title:"Chapter "+a[2],onDone:()=>w("#/referans/bolum")}):a[1]==="bolum"?e.jsxs("div",{className:"flex flex-col gap-3 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:()=>w("#/referans"),className:"text-neutral-400",children:"← Reference"}),e.jsx("span",{className:"font-semibold text-neutral-100",children:"📖 New Chapters (v5)"}),e.jsx("span",{className:"w-16"})]}),e.jsx("p",{className:"text-[13px] leading-relaxed text-neutral-400",children:"Tournament-winning chapters — straight from the book. Check the table on your phone during breaks."}),va.map(h=>e.jsxs("button",{onClick:()=>w("#/referans/bolum/"+h.n),className:"card flex items-center justify-between p-3 text-left",children:[e.jsxs("span",{className:"text-[14px] text-neutral-100",children:[e.jsxs("span",{className:"font-mono text-neutral-500",children:["C",h.n]})," · ",h.short]}),e.jsx("span",{className:"text-accent",children:"→"})]},h.n))]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"grid grid-cols-2 gap-2 p-4 pb-0",children:[e.jsx("button",{onClick:()=>w("#/referans/araliklar"),className:"btn-accent py-2.5",children:"🗂️ Range Guide →"}),e.jsx("button",{onClick:()=>w("#/referans/cumleler"),className:"btn-ghost py-2.5",children:"🧠 15 Sentences (memorize) →"}),e.jsx("button",{onClick:()=>w("#/referans/equity"),className:"btn-ghost col-span-2 py-2.5",children:"📐 Equity Intuition (bonus · outside the book) →"}),e.jsx("button",{onClick:()=>w("#/referans/bahis"),className:"btn-ghost col-span-2 py-2.5",children:"🎯 Bet Types (value/bluff/thin/overbet) →"}),e.jsx("button",{onClick:()=>w("#/referans/sorubankasi"),className:"btn-ghost col-span-2 py-2.5",children:"📝 Question Bank (Chapter 10 · 37 questions) →"}),e.jsx("button",{onClick:()=>w("#/referans/icmkart"),className:"btn-ghost col-span-2 py-2.5",children:"🧮 My ICM Card (ladder + <15bb jam · Chapter 12) →"}),e.jsx("button",{onClick:()=>w("#/referans/bolum"),className:"btn-accent col-span-2 py-2.5",children:"📖 New Chapters v5 (ICM · River · Multiway…) →"})]}),e.jsx(qa,{})]}))]})}),e.jsx("nav",{"aria-label":"Main tabs",className:"grid grid-cols-5 border-t border-surface-3 bg-surface-1 pb-[env(safe-area-inset-bottom)]",children:$a.map(h=>{const c=h.id===o;return e.jsxs("button",{"aria-current":c?"page":void 0,onClick:()=>w("#/"+h.id),className:"flex flex-col items-center gap-0.5 py-2.5 text-xs transition "+(c?"text-accent":"text-neutral-500"),children:[e.jsx("span",{className:"text-lg",children:h.icon}),h.label]},h.id)})})]})}class Va extends ze.Component{constructor(){super(...arguments);H(this,"state",{hasError:!1})}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(n){console.error("EPT ErrorBoundary:",n)}async resetData(){const n=Object.keys(localStorage).filter(s=>s.startsWith("ept:")),o=Object.fromEntries(n.map(s=>[s,localStorage.getItem(s)]));try{await navigator.clipboard.writeText(JSON.stringify(o,null,2))}catch{}n.forEach(s=>localStorage.removeItem(s)),location.reload()}render(){return this.state.hasError?e.jsxs("div",{className:"mx-auto flex h-[100dvh] max-w-md flex-col items-center justify-center gap-4 bg-surface-0 p-6 text-center",children:[e.jsx("p",{className:"text-lg font-semibold text-neutral-100",children:"Something went wrong."}),e.jsx("button",{className:"btn-accent",onClick:()=>location.reload(),children:"Reload"}),e.jsx("button",{className:"btn-ghost text-sm",onClick:()=>this.resetData(),children:"Reset data (copy JSON first)"})]}):this.props.children}}ve.createRoot(document.getElementById("root")).render(e.jsx(ze.StrictMode,{children:e.jsx(Va,{children:e.jsx(_a,{})})}));"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/ept-trainer-en/sw.js").catch(()=>{})});export{rn as A,ue as B,J as C,Le as D,ke as E,nn as F,on as G,ca as H,sn as I,At as J,Ue as K,Nn as L,ie as M,ea as N,ta as O,en as P,tn as Q,tt as R,xt as S,cn as T,aa as U,hn as V,yn as W,gn as X,wn as Y,dn as Z,Ve as a,mn as b,Ge as c,Be as d,Ft as e,fn as f,pn as g,bn as h,na as i,e as j,xn as k,E as l,kn as m,Tn as n,un as o,we as p,jn as q,an as r,P as s,vn as t,An as u,Bn as v,Bt as w,F as x,Ot as y,ln as z};
